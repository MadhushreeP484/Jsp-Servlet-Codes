...
<title>Fetch All Patient For Staff</title>
...
<div class="topnav"><a href="staffHome.jsp"><button>Back</button></a></div><br>
<table border="1">
...
<%for(PatientDto dto:list){%>
	...
	<td><a href="checkAppointmentsFromStaff.jsp?id=<%=dto.getId()%>"><button type="submit">See Appointments</button></a></td>
<%} %>
</table>
<%} %>
</body>
