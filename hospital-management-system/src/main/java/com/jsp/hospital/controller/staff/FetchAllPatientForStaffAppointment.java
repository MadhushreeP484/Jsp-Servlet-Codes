...
@WebServlet("/viewPatientForStaffApo")
public class FetchAllPatientForStaffAppointment extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(patientDtos.isEmpty()) {
			...
			req.getRequestDispatcher("fetchAllPatientForStaffAppointment.jsp").include(req, resp);
		}
		}
	}
