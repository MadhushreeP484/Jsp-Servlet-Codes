...
@WebServlet("/approveDoctorStatus")
public class ApproveDoctorStatusController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("Invoked ApproveDoctorStatusController service");
		
		int id= Integer.parseInt(req.getParameter("dId"));
		this.doctorDao.updateDoctorStatus(id);
